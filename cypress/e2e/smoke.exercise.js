...
import booksData from '../support/books-data'
...
describe('smoke', () => {
  it('should allow a typical user flow', () => {
    ...
    const bookName = faker.random.arrayElement(booksData).title
    ...
    cy.findByRole('main').within(() => {
      ...
      cy.findByRole('textbox').type(faker.lorem.words())
    ...
    cy.findByRole('main').within(() => {
      ...
      cy.findAllByRole('radio', {name: /stars/i}).should('not.exist')
    })
